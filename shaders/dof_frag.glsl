...
uniform sampler2D colourTexFromFBo1;
uniform sampler2D depthTexFromFBo1;
...
void main() {    
    ...
    float sigma = abs(1 - texture(depthTex, texpos).x) * blurRadius;
    ...
    // Show depth
    //    fragColor = texture(depthTex, texpos);
}
